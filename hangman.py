...
myword = choice(["code", "club", "pizza", "elmo", "nemo", "sleep", "panda", "dwarves", "awkward", "jazz", "jukebox", "pixel", "sphynx", "zombie", "mystify", "oxygen", "haphazard", "gym", "myth", "shy", "glyphs", "nymphs", "rhythm"])
