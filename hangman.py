...
myword = choice(["code", "club", "pizza", "elmo", "nemo", "sleep", "panda", "dwarves", "awkward", "jazz", "jukebox", "pixel", "sphynx", "zombie", "mystify", "oxygen", "haphazard"])
...
turns = int(input("plese tipe the number of tries: ")) 
